...
# This number line starts at the first value 
...
p how_many_missing([1, 3])
p how_many_missing([7, 10, 11, 12])
p how_many_missing([1, 3, 5, 7, 9, 11])
p how_many_missing([5, 6, 7, 8])